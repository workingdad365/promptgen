...
class ExternalLLMClient:
    ...
    def _test_openai(self) -> Tuple[bool, str]:
        ...
        if not OPENAI_AVAILABLE:
            return False, "❌ openai 패키지가 설치되어 있지 않습니다. pip install openai 실행 필요"
    ...
    def _test_gemini(self) -> Tuple[bool, str]:
        ...
        if not GEMINI_AVAILABLE:
            return False, "❌ google-genai 패키지가 설치되어 있지 않습니다. pip install google-genai 실행 필요"
    ...
    def _test_anthropic(self) -> Tuple[bool, str]:
        ...
        if not ANTHROPIC_AVAILABLE:
            return False, "❌ anthropic 패키지가 설치되어 있지 않습니다. pip install anthropic 실행 필요"
...
- Return ONLY the Korean translation"""
    ...
    def enhance_prompt(self, original_prompt: str, user_requirements: Optional[str] = None) -> str:
        """프롬프트 개선"""
