...
class OllamaClient:
    ...
    def test_connection(self) -> Tuple[bool, str]:
        try:
            ...
            if response.status_code == 200:
                ...
                return True, f"✅ Ollama 서버 연결 성공! ({len(self._available_models)}개 모델 발견)"
            else:
    ...
    def _load_models(self, response_data: dict):
        ...
        for model in models:
            self._available_models.append(OllamaModel(
    ...
    def chat(
        ...
        try:
            ...
            raise TimeoutError("응답 시간 초과. 더 작은 모델을 사용하거나 요청을 단순화하세요.")
        except Exception as e:
